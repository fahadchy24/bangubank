      ...
      <div class="px-4 pb-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <?php if (isset($_SESSION['message'])) : ?>
          <div class="my-2 bg-red-100 border border-red-200 text-sm text-red-800 rounded-lg p-4" role="alert">
            <span class="font-bold"><?= $_SESSION['message']; ?></span>
          </div>
        <?php endif; ?>
                  ...
                  <li
                    ...
                    <div class="flex gap-x-4">
                      ...
                      <span
                        ...
                        <span
                          class="text-xl font-medium leading-none text-white">AN</span>
                      </span>
                      ...
                      <div class="flex-auto min-w-0">
                        ...
                        <p class="flex mt-1 text-xs leading-5 text-gray-500">
                          <a
                            ...
                            class="relative truncate hover:underline">alnahian@2003.com</a>
                        </p>
                      </div>
                    </div>
                  </li>
                  ...
                  <li
                    ...
                    <div class="flex gap-x-4">
                      ...
                      <span
                        ...
                        <span
                          class="text-xl font-medium leading-none text-white">MM</span>
                      </span>
                      <div class="flex-auto min-w-0">
                        <p
                          class="text-sm font-semibold leading-6 text-gray-900">
                  ...
                  <li
                    ...
                    <div class="flex gap-x-4">
                      ...
                      <span
                        ...
                        <span
                          class="text-xl font-medium leading-none text-white">PK</span>
                      </span>
                      <div class="flex-auto min-w-0">
                        <p
                          class="text-sm font-semibold leading-6 text-gray-900">
                        ...
                        <p class="flex mt-1 text-xs leading-5 text-gray-500">
                          <a
                            href="./customer_transactions.html"
                            class="relative truncate hover:underline">povilas@korop.com</a>
                        </p>
                      </div>
                    </div>
                  </li>
                  ...
                  <li
                    ...
                    <div class="flex gap-x-4">
                      ...
                      <span
                        ...
                        <span
                          class="text-xl font-medium leading-none text-white">LF</span>
                      </span>
                      <div class="flex-auto min-w-0">
                        <p
                          class="text-sm font-semibold leading-6 text-gray-900">
                        ...
                        <p class="flex mt-1 text-xs leading-5 text-gray-500">
                          <a
                            href="./customer_transactions.html"
                            class="relative truncate hover:underline">laravel@framework.com</a>
                        </p>
                      </div>
                    </div>
                  </li>
                  ...
                  <li
                    ...
                    <div class="flex gap-x-4">
                      ...
                      <span
                        ...
                        <span
                          class="text-xl font-medium leading-none text-white">JW</span>
                      </span>
                      <div class="flex-auto min-w-0">
                        <p
                          class="text-sm font-semibold leading-6 text-gray-900">
                        ...
                        <p class="flex mt-1 text-xs leading-5 text-gray-500">
                          <a
                            href="./customer_transactions.html"
                            class="relative truncate hover:underline">jeffrey@way.com</a>
                        </p>
                      </div>
                    </div>
                  </li>
                  ...
                  <li
                    ...
                    <div class="flex gap-x-4">
                      ...
                      <span
                        ...
                        <span
                          class="text-xl font-medium leading-none text-white">AG</span>
                      </span>
                      <div class="flex-auto min-w-0">
                        <p
                          class="text-sm font-semibold leading-6 text-gray-900">
                        ...
                        <p class="flex mt-1 text-xs leading-5 text-gray-500">
                          <a
                            href="./customer_transactions.html"
                            class="relative truncate hover:underline">alex@smith.com</a>
                        </p>
                      </div>
                    </div>
                  </li>
